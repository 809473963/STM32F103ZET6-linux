...
void uart_init(u32 bound)
{
  ...
  USART_Cmd(USART1, ENABLE);                    //使能串口1 
	...
	// USART2 (PA2/PA3) and USART3 (PB10/PB11) are not connected in this application.
	// Configuring their RX pins as floating inputs and enabling RXNE interrupts causes
	// continuous noise-driven Protocol_ParseByte() calls that corrupt the shared
	// protocol state machine. Keep RX pins pulled up and leave interrupts disabled.
	...
	// g_usart2_ready and g_usart3_ready remain 0: fputc will not mirror to USART2/3.
